    ...
    if op1 == 0:
        if op2 == 0:
            ...
            while (first < third):
                ...
                mins = min(first, second)
            if pos == 0:
                return {'sk': '__ + ' + str(maxs - mins) + ' - ' + str(third) + ' = ' + str(maxs - third),
                        'ak': str(mins)}
            elif pos == 1:
        ...
        if op2 == 0:
            ...
            while ((mins + third) >= 100):
                third = randint(0, 100)
            if pos == 0:
                return {'sk': '__ - ' + str(maxs - mins) + ' + ' + str(third) + ' = ' + str(mins + third),
                        'ak': str(maxs)}
            elif pos == 1:
            ...
            mids = sum([first, second, third]) - maxs - mins
            if pos == 0:
                return {'sk': '__ - ' + str(maxs - mids) + ' - ' + str(mids - mins) + ' = ' + str(mins),
                        'ak': str(maxs)}
            elif pos == 1:
    ...
    if op1 == 0:
        if op2 == 0:
            ...
            if pos == 0:
                ...
                return {
                    'sk': str(2 * maxs + mins - sums) + ' + ' + str(sums - maxs - mins) + ' - __ = ' + str(maxs - mins),
                    'ak': str(mins)}
            else:
                return {
                    'sk': str(2 * maxs + mins - sums) + ' + ' + str(sums - maxs - mins) + ' - ' + str(mins) + ' = __',
                    'ak': str(maxs - mins)}
        elif op2 == 2:
            second = randint(1, 9)
            third = randint(1, 9)
        ...
        if op2 == 0:
            ...
            sums = sum([first, second, third])
            if pos == 0:
                return {'sk': '__ - ' + str(2 * maxs - sums + mins) + ' - ' + str(sums - maxs - 2 * mins) + ' = ' + str(
                    mins + third),
                        'ak': str(maxs)}
            elif pos == 1:
                return {'sk': str(maxs) + ' - __ - ' + str(third) + ' = ' + str(mins + third),
                ...
                return {'sk': str(maxs) + ' - ' + str(2 * maxs - sums + mins) + ' - ' + str(
                    sums - maxs - 2 * mins) + ' = __',
                        'ak': str(mins + third)}
        elif op2 == 2:
            second = randint(1, 9)
